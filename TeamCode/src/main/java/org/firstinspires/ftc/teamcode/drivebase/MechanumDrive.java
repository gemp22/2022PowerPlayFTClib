...
import org.firstinspires.ftc.teamcode.geometery.Vector2d;
...
public class MechanumDrive extends RobotDrive{
     ...
     */
    public MechanumDrive(Motor frontLeft, Motor frontRight, Motor backLeft, Motor backRight) {
     ...
     * @param backRight  the back right motor
     */
    public MechanumDrive(boolean autoInvert, Motor frontLeft, Motor frontRight, Motor backLeft, Motor backRight) {
